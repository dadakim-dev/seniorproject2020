...
public class OSMTokenController {
    public Token getToken() {
        ...
        try {
            String url = "http://54.180.149.38:8888/osm/admin/v1/tokens";
            ...
            JSONObject rawData = (JSONObject) parser.parse("{\"username\": \"admin\", \"password\": \"admin\", \"project_id\" : \"048eb05cb5ca49fc8ade679865796c0b\"}");
